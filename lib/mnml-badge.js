import{a as t,b as e,c as o}from"./chunk-fd2d1ba7.js";class r extends t{static get styles(){return[super.styles,e`
        .container {
          position: relative;
    ...
    `}renderBadge(){const t=!!(this.maxcount&&this.count>this.maxcount);return o`
      <div class="badge">${t?`${this.maxcount}+`:this.count}</div>
    `}render(){return o`
      <div class="container">
        test
